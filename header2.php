...
<head>
	...
	<meta charset="utf-8">
	<meta name="keywords" content="HLoan Website, Get Quick Loan, Loans in Nigeria, 2 minutes Loan n" />
	<script>
			...
			<div class="container">
				<div class="t-op row">
					...
					<div class="col-sm-6 top-left">
						<ul>
							<li class="mr-3"><i class="fas fa-phone"></i> 0803-Tactika</li> 
							<li><i class="fas fa-phone"></i> 0809-Tactika</li>
						</ul>
					</div>
				</div>
			</div>
